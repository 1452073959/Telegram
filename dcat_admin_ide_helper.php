...
namespace Dcat\Admin {
     ...
     * @property Grid\Column|Collection u_address
     * @property Grid\Column|Collection publish_channel
     ...
     * @method Grid\Column|Collection u_address(string $label = null)
     * @method Grid\Column|Collection publish_channel(string $label = null)
     ...
     * @property Show\Field|Collection u_address
     * @property Show\Field|Collection publish_channel
     ...
     * @method Show\Field|Collection u_address(string $label = null)
     * @method Show\Field|Collection publish_channel(string $label = null)
